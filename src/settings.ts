...
export const VALIDATE_AGENT_URL = "https://europe-west1-narratory-1.cloudfunctions.net/validate_v" + API_VERSION
export const VALIDATE_AGENT_URL_LOCAL = "http://localhost:5000/narratory-1/europe-west1/validate_v" + API_VERSION 
